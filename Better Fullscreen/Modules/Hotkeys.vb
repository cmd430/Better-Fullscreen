...
Public NotInheritable Class Hotkeys
  ...
  Private Class Window
    ...
    Protected Overrides Sub WndProc(ByRef m As Message)
      ...
      If m.Msg = WM_HOTKEY Then
        ...
        Dim modifier As ModifierKey = DirectCast(CUInt(CInt(m.LParam) And &HFFFF), ModifierKey)
...
Public Class KeyPressedEventArgs
  ...
  Public ReadOnly Property Modifier() As ModifierKey
    Get
      Return _modifier
    End Get
  End Property
